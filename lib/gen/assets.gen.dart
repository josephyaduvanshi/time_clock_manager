...
class $AssetsAnimationsGen {
  ...
  /// File path: assets/animations/vertical_loading.json
  String get verticalLoading => 'assets/animations/vertical_loading.json';

  /// List of all assets
  List<String> get values => [verticalLoading];
}
