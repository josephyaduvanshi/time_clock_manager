                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                        ...
                        onSaved: (value) {
                          controller.confirmPasswordControllerForSignUp.text =
                              value!;
                        },
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: InkWell(
                              ...
                              child: Icon(controller.isPasswordHidden2.isTrue
                                  ? Icons.visibility_off
                                  : Icons.visibility)),
                        ...
                        validator: (value) {
                          ...
                          if (controller
                                  .confirmPasswordControllerForSignUp.text !=
                          ...
                          onTap: () async {
                            ...
                            if (_formKey.currentState!.validate()) {
                              await controller.signUp(
                                  email:
                                      controller.emailControllerForSignUp.text,
                                  password: controller
                                      .passwordControllerForSignUp.text,
                                  name:
                                      controller.nameControllerForSignUp.text);
                            }
                          },
                          title: "Sign Up",
                        ),
